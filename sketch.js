...
function setup() {
  ...
  invisibleGround = createSprite(200,windowHeight-190,400,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") && trex.y >= windowHeight-240 ) {
      trex.velocityY = -12;
    }
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth,windowHeight-218,10,40);
    //obstacle.debug = true;
